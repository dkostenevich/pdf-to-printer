...
test("fixes path for Electron apps", () => {
  const path =
    "/Users/dkostenevich/My.app/Contents/Resources/app.asar/node_modules/foo/binary";
  ...
  expect(fixPathForAsarUnpack(path)).toBe(
    "/Users/dkostenevich/My.app/Contents/Resources/app.asar.unpacked/node_modules/foo/binary",
  );
});
